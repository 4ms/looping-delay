...
constexpr inline PinDef D3{GPIO::H, PinNum::_14};
constexpr inline PinDef D4{GPIO::D, PinNum::_7};
constexpr inline PinDef D5{GPIO::I, PinNum::_0};
constexpr inline PinDef D6{GPIO::I, PinNum::_2};
...
// TODO: Debug0 and Debug1 are not on the schematic.. are there dummy pins or
